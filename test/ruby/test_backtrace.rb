...
class TestBacktrace < Test::Unit::TestCase
  ...
  def build_bt_prog(run_expr, frame_count: 1)
    ...
    <<~RUBY
      ...
      $captured_locs[0...#{frame_count}].each { puts _1.full_label}
    RUBY
  end

  def test_full_instance_method
  ...
  def test_full_block_in_bmethod
    program = build_bt_prog("SimpleExampleClass.new.call_block_from_bmethod", frame_count: 3)
    # Because of the above comment in test_full_bmethod, there's actually no way
  ...
  def test_full_inside_module_definition
  ...
  def test_full_inside_class_definition
  ...
  def test_full_inside_anon_module_definition
  ...
  def test_full_module_extended_hook
  ...
  def test_full_block_in_refinement_method
  ...
  def test_full_refinement_singleton_method
  ...
  def test_full_singleton_defined_on_singleton
  ...
  def test_full_toplevel_nested_eval
  ...
  def test_full_bmethod_defined_in_block
  ...
  def test_full_block_nested_in_method
  ...
  def test_full_aliased_method
    program = build_bt_prog("SimpleExampleClass.new.aliased_ex_instance")
    expected = ["SimpleExampleClass#ex_instance (aliased as #aliased_ex_instance)"]
    assert_in_out_err([], program, expected, [])
  end

  def test_full_included_method
